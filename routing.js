...
vorpal
  .command('exec cli show static route <node_id>')
  ...
  .action(function(args, callback) {
    ...
    request
      .get('http://' + odl_ip + ':8181/restconf/operational/network-topology:network-topology/topology/cli/node/' +
        args.node_id + '/yang-ext:mount/openconfig-network-instance:network-instances/network-instance/default/protocols/protocol/openconfig-policy-types:STATIC/default')
      .auth(odl_user, odl_pass)
      .accept('application/json')
      .set('Content-Type', 'application/json')
...
vorpal
  .command('exec cli show network-instances <node_id>')
  ...
  .action(function(args, callback) {
    ...
    request
      .get('http://' + odl_ip + ':8181/restconf/operational/network-topology:network-topology/topology/cli/node/' +
        args.node_id + '/yang-ext:mount/openconfig-network-instance:network-instances')
      .auth(odl_user, odl_pass)
      .accept('application/json')
      .set('Content-Type', 'application/json')
